...
export const ServicesItem: FC<ServicesItemProps> = ({
  ...
  const { data } = useGetPriceListCategoriesQuery();

  const category_found = data?.price_list_categories.find(
  ...
  return (
    <div className="flex gap-10 flex-col lg:flex-row items-center lg:items-start shadow-xl rounded-2xl bg-white  p-3 lg:p-0">
      <AdvancedImage
        cldImg={imageCld}
        width={395}
        height={593}
      ...
      <div className="flex flex-col gap-12 p-3">
        <div className="flex flex-col gap-3">
          ...
          <p className="text-2xl text-gray-600">{category_found?.title}</p>
        </div>
